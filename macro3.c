...
//This is for the full tracking case
    ...
    //TH1D *h1= (TH1D*)f1->Get("FullBkg_fake_rate_by_Seed_theta");
    h1->SetStats(0);
    h1->Draw("hist l");
    h1->SetLineWidth(1);
    h1->SetLineColor(2);
    ...
    //TH1D *h8= (TH1D*)f8->Get("FullBkg_fake_rate_by_Seed_theta");
    h8->SetStats(0);
    h8->Draw("hist l same");
    h8->SetLineWidth(1);
    h8->SetLineColor(15);
    ...
    //No L3 side 0
    TFile *f2 = TFile::Open("noL3_Side0_1000evts_PXDredON_FullTrackingValidationBkg.root");
    ...
    //TH1D *h2= (TH1D*)f2->Get("FullBkg_fake_rate_by_Seed_theta");
    h2->SetStats(0);
    h2->Draw("hist l same");
    h2->SetLineWidth(1);
    h2->SetLineColor(3);
    ...
    //TH1D *h3= (TH1D*)f3->Get("FullBkg_fake_rate_by_Seed_theta");
    h3->SetStats(0);
    h3->Draw("hist l same");
    h3->SetLineWidth(1);
    h3->SetLineColor(4);
    ...
    //TH1D *h4= (TH1D*)f4->Get("FullBkg_fake_rate_by_Seed_theta");
    h4->SetStats(0);
    h4->Draw("hist l same");
    h4->SetLineWidth(1);
    h4->SetLineColor(6);
    ...
    //TH1D *h5= (TH1D*)f5->Get("FullBkg_fake_rate_by_Seed_theta");
    h5->SetStats(0);
    h5->Draw("hist l same");
    h5->SetLineWidth(1);
    h5->SetLineColor(8);
    ...
    //TH1D *h6= (TH1D*)f6->Get("FullBkg_fake_rate_by_Seed_theta");
    h6->SetStats(0);
    h6->Draw("hist l same");
    h6->SetLineWidth(1);
    h6->SetLineColor(9);
    ...
    //TH1D *h7= (TH1D*)f7->Get("FullBkg_fake_rate_by_Seed_theta");
    h7->SetStats(0);
    h7->Draw("hist l same");
    h7->SetLineWidth(1);
    h7->SetLineColor(12);
    ...
    leg->SetHeader("Full Tracking Validation","C");
